      ...
      <div className="min-h-screen bg-[hsl(0,0%,100%)] dark:bg-gray-900 text-gray-900 dark:text-white transition-colors duration-300">
        ...
        <section className="py-18 px-4 bg-white dark:bg-gray-800">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-12 pt-10 text-gray-900 dark:text-white">What we offer?</h2>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-12">
              {[
                ...
                <Card key={index} className="p-6 h-full flex flex-col items-center justify-center text-center bg-white dark:bg-gray-800">
                  <h3 className="text-xl font-semibold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-purple-500 via-violet-500 to-pink-500">{feature.title}</h3>
                  <p className="text-gray-600 dark:text-gray-300">{feature.description}</p>
                </Card>
              ))}
            </div>
