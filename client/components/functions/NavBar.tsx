                    ...
                    <div className="flex items-center gap-4">
                        <nav className="hidden lg:block mr-4">
                            <div className="flex gap-6">
                                ...
                                <NavLink href="/planning" icon={<GoDiscussionClosed className="h-5 w-5" />} text="Planning" />
                                <NavLink href="/tenders" icon={<FaCompressArrowsAlt className="h-5 w-5" />} text="Tenders" />
